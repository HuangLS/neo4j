        ...
        EntityReadOperations
{
    ...
    {
        guard.check();
        return entityReadDelegate.nodeGetTemporalProperty(statement, nodeId, propertyKeyId, time);
    }
    ...
    {
        guard.check();
        return entityReadDelegate.nodeGetTemporalProperties(statement, nodeId, propertyKeyId, startTime, endTime, callback);
    }
    ...
    {
        guard.check();
        return entityReadDelegate.relationshipGetTemporalProperty(statement, relId, propertyKeyId, time);
    }
    ...
    {
        guard.check();
        return entityReadDelegate.relationshipGetTemporalProperties(statement, relId, propertyKeyId, startTime, endTime, callback);
    }
